...
var $author$project$Pages$Home$NothingHereYet = function (a) {
	return {$: 'NothingHereYet', a: a};
};
var $author$project$Pages$Home$init = function (store) {
	return _Utils_Tuple2(
		$author$project$Pages$Home$NothingHereYet(store),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Page$view = function (_v0) {
	var pageTitle = _v0.pageTitle;
	var headerView = _v0.headerView;
	var footerView = _v0.footerView;
	var pageContent = _v0.pageContent;
	return {
...
var $author$project$Pages$Home$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$UI$buttonView, 'My Button', $author$project$Pages$Home$NothingHereYetMsg),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
...
_Platform_export({'App':{'init':$author$project$App$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"App.Msg":{"args":[],"tags":{"UserChangedUrl":["Url.Url"],"UserClickedLink":["Browser.UrlRequest"],"GotHomeMsg":["Pages.Home.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Pages.Home.Msg":{"args":[],"tags":{"NothingHereYetMsg":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));